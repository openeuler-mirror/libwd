...
define warpdrive_cmd_install
	...
	cp -rf $(PRIVATE_PATH)/test/test_mm/test_wd_mem $(call warpdrive_get_install_bin_dir)
	cp -rf $(PRIVATE_PATH)/test/bmm_test/bmm_test $(call warpdrive_get_install_bin_dir)
endef
